...
INSERT INTO streamers
        VALUES('GoBGG','gobgg',false,0,'http://static-cdn.jtvnw.net/previews-ttv/live_user_gobgg-320x180.jpg',true),
              ...
              ('Taour','taourrr1030',false,0,'http://static-cdn.jtvnw.net/previews-ttv/live_user_taourrr1030-320x180.jpg',true),
              ...
              ('Sneaky','c9sneaky',false,0,'http://static-cdn.jtvnw.net/previews-ttv/live_user_c9sneaky-320x180.jpg',true);
                          ...
                          ('GoB GG','euw','18998522','gobgg',true);
                          --Summoners SirhcEz
                          INSERT INTO summoners VALUES
                          ('Liquid SirhcEz','na','20526961','SirhcEz',true);
                          --Summoners Nightblue3
                          INSERT INTO summoners VALUES
                          ('Nightblue3','na','25850956','Nightblue3',true),
                          ('EU Flamingo','euw','77348710','Nightblue3',true),
                          ('SKT T1 Nightblue','na','28753857','Nightblue3',true),
                          ('Nightbluex','na','67029611','Nightblue3',true);
                          --Summoners GoodGuyGarry
                          INSERT INTO summoners VALUES
                          ('Bronze 5 Haircut','na','72720995','GoodGuyGarry',true);
                          --Summoners Wingsofdeath
                          INSERT INTO summoners VALUES
                          ('Wingsofdeath','na','53742348','Wingsofdeath',true);
                          --Summoners mushisgosu
                          INSERT INTO summoners VALUES
                          ('hi im gosu','na','23557909','mushisgosu',true),
                          ('45620','na','20967047','mushisgosu',true);
                          --Summoners imaqtpie
                          INSERT INTO summoners VALUES
                          ('Imaqtpie','na','19887289','imaqtpie',true),
                          ('feed l0rd','na','35301382','imaqtpie',true),
                          ('clg imaqtpie69','na','20964624','imaqtpie',true);
                          ...
                          --Summoners iamcrvor
                          INSERT INTO summoners VALUES
                          ('crvor','euw','18977877','iamcrvor',true);
                          --Summoners sylrus
                          INSERT INTO summoners VALUES
                          ('Pornstar Dovah','euw','59837265','sylrus',true),
                          ('Sylrus','euw','27979793','sylrus',true);
                          --Summoners c9sneaky
                          INSERT INTO summoners VALUES
                          ('C9 StealthBomber','na','44989300','c9sneaky',true);
